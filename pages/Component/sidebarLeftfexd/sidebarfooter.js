...
export default function Sidebarfooter() {
    return (
        <>
            <Stack direction="horizontal" gap={2} className="ps-4 pb-2">
                <div className="mb-2 me-1" style={{backgroundImage:"url('/imges/users/Rectangle 114.png')"}}>
                    <Image src="/imges/users/Rectangle 115.png" width={45} height={43}/>
                </div>

                <div className="mt-3 ">
                    <h6 className="p-0 m-0">Easin Arafat</h6>
                    <p className="userAccount">Free Account</p>
                </div>
